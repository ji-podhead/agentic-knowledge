---
okf_version: "1.0"
id: "okf-ana-met-model-statistics-pipeline"
...
summary: "Wie nutzen wir OpenRouter stats, künstliche analyse, and SearXNG als fallback"
---
...
- [ ] SearXNG: self-hosted meta search engine
  - User hostet SearXNG instance (or The Multi-Provider Gateway bundled?)
...
- [ ] Welches model?
  - `utility` role from model role schemas (Milestone Work Package)
