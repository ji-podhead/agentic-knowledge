---
okf_version: "1.0"
id: "okf-sec-gua-guardrails-otel-reference-stack"
...
summary: "**Source:** System Administrator 13.9.2026 („Guardrails + OTel implementieren falls es"
---

# R37 — Guardrails, OpenTelemetry & OSS-Referenz-Stack (Lizenz-Fundstellen)

**Source:** System Administrator 13.9.2026 („Guardrails + OTel implementieren falls es
...
| Framework | Lizenz (verifiziert) | Sprache | Verdict for The Multi-Provider Gateway |
|---|---|---|---|
...
- **Existing Infrastructure:** `internal/tracing` (Milestone) exportiert seit langem
...
**Decision (Work Package):** Logger-SDK v1 = eigenes kompaktes Schema with
...
|---|---|---|---|
| `modelcontextprotocol/go-sdk` (offiziell) | **MIT → Apache-2.0 Transition** (LICENSE-Header verifiziert; neuer Code Apache-2.0) | 5.1k | Offiziell, Zukunftssicher — **Recommendation for Work Package.** |
| `mark3labs/mcp-go` | MIT, 9.1k★ | Community | Reifer API-Surface, viele Beispiele („Awesome MCP Servers" als Server-Blueprints). |

Fallback-Strategie: Beide sind MIT/Apache-kompatibel — Work Package startet with
...
- **ProxySQL** (`sysown/proxysql`): **GPL-3.0** ❌ no Code. L7-Parsing-
  Muster-Referenz (MySQL-fokussiert; for Postgres haben wir pgproto3, s. Milestone §2b).
...
## 6. Debezium-Envelope (vom System Administrator bestätigt, Fundstelle ergänzt)
...
Insert/Update/Delete-Anzeige) — wie im Milestone §Work Package geplant.
