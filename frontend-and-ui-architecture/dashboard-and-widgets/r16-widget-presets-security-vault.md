---
okf_version: "1.0"
id: "okf-fro-das-r16-widget-presets-security-vault"
...
summary: "OpenMesh dashboard wird widget-based (wie leobot2 trading bot):"
---

# R16 — Widget Presets, App Categories, Security/SecOps & Vault

## Vision
OpenMesh dashboard wird widget-based (wie leobot2 trading bot):
...
### Widget Registry (OpenMesh-specific)
```typescript
WIDGET_REGISTRY = {
  // mesh
...
Sidebar:
  ...
  📂 Terminals
    └── ttyd (project-a) → :7681
  📂 Monitoring
    └── OpenMesh Backend → :9091
```

### Smart Suggestions
When a database is deployed, OpenMesh suggests complementary apps:
...
- Wireframe view: shows request flow: client → OpenMesh → model → response
...
- Nodes: OpenMesh proxy, chains, models, deployments, discovered services
